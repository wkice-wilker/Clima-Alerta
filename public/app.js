...
cityButtons.forEach((button) => {
  button.addEventListener("click", () => {
    ...
    const detalhePrevisao = document.querySelector('.temperature-details');
    ...
    detalhePrevisao.style.display = 'flex';
...
function requestAr(cityName) {
  ...
  if (cityName === 'caraguatatuba') {
    ...
    console.log('Cidade não suportada qualidade do ar');
    return;
  }
...
function requestsaude(requestCityName) {
  ...
  if (requestCityName === 'caraguatatuba') {
    ...
    console.log('Cidade não suportada para saude');
    return;
  }
